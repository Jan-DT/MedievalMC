...
public class IronBladeRegularItem extends MedievalmcModElements.ModElement {
	@ObjectHolder("medievalmc:iron_blade_regular")
	public static final Item block = null;
	public IronBladeRegularItem(MedievalmcModElements instance) {
		super(instance, 8);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("iron_blade_regular");
		}
