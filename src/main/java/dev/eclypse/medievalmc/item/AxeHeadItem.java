...
public class AxeHeadItem extends MedievalmcModElements.ModElement {
	@ObjectHolder("medievalmc:axe_head")
	public static final Item block = null;
	public AxeHeadItem(MedievalmcModElements instance) {
		super(instance, 18);
	}
