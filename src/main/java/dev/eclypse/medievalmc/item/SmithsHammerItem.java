...
public class SmithsHammerItem extends MedievalmcModElements.ModElement {
	@ObjectHolder("medievalmc:smiths_hammer")
	public static final Item block = null;
	public SmithsHammerItem(MedievalmcModElements instance) {
		super(instance, 4);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			super(new Item.Properties().group(MedievalmcPartsItemGroup.tab).maxDamage(100));
			setRegistryName("smiths_hammer");
		}
