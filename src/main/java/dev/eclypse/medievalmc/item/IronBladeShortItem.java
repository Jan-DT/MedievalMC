...
public class IronBladeShortItem extends MedievalmcModElements.ModElement {
	@ObjectHolder("medievalmc:iron_blade_short")
	public static final Item block = null;
	public IronBladeShortItem(MedievalmcModElements instance) {
		super(instance, 9);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("iron_blade_short");
		}
