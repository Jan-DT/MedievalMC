...
public class OilBlock extends MedievalmcModElements.ModElement {
	@ObjectHolder("medievalmc:oil")
	public static final FlowingFluidBlock block = null;
	@ObjectHolder("medievalmc:oil_bucket")
	public static final Item bucket = null;
	public static FlowingFluid flowing = null;
	public static FlowingFluid still = null;
	private ForgeFlowingFluid.Properties fluidproperties = null;
	public OilBlock(MedievalmcModElements instance) {
		super(instance, 27);
	...
	public void initElements() {
		fluidproperties = new ForgeFlowingFluid.Properties(() -> still, () -> flowing,
				FluidAttributes.builder(new ResourceLocation("medievalmc:blocks/oil_flow"), new ResourceLocation("medievalmc:blocks/oil_still"))
						.luminosity(0).density(5000).viscosity(5000)).block(() -> block);
